...
<html lang="en">
  ...
  <body>
    <div class="main-slider animate-in">
            <img src="<g:resource dir='images' file='fondo.jpg'/>" class="slider-hill" alt="BikeApp - home" width="100%" height="100%" style="">
            </img>

        </div>


        <section id="team" style="margin-top:-85px;">
                <div class="container">
                    <div class="row">
                    <!--      <h1 class="title text-center wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 500ms; animation-delay: 300ms; animation-name: fadeInDown;">No te puedes perder</h1>
                      <p class="text-center wow fadeInDown animated" data-wow-duration="400ms" data-wow-delay="400ms" style="visibility: visible; animation-duration: 400ms; animation-delay: 400ms; animation-name: fadeInDown;">Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <br>
                        ...
                        <div id="team-carousel" class="carousel slide wow fadeIn animated" data-ride="carousel" data-wow-duration="400ms" data-wow-delay="400ms" style="visibility: visible; animation-duration: 400ms; animation-delay: 400ms; animation-name: fadeIn;">
                            ...
                            <ol class="carousel-indicators visible-xs">
                                <li data-target="#team-carousel" data-slide-to="0" class=""></li>
                                <li data-target="#team-carousel" data-slide-to="1" class="active"></li>
                            </ol>
                            <!-- Wrapper for slides -->
